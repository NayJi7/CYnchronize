...
CREATE DATABASE LINK dblink_cergy
    ...
    USING '(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=oracle-cergy)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=XEPDB1)))';

SELECT * FROM dual@dblink_cergy;
SELECT * FROM GLPI_OWNER.SITE@dblink_cergy WHERE ROWNUM = 0;
